...
namespace {
  ...
  // need to match those used in UBGenieWeightCalc::SetupWeightCalculators(), specifically in the
...
namespace evwgh {
  class UBGenieWeightCalc : public WeightCalc {
    public:
    ...
    private:
      ...
      DECLARE_WEIGHTCALC(UBGenieWeightCalc)
  };

  UBGenieWeightCalc::UBGenieWeightCalc()
  {}

  void UBGenieWeightCalc::Configure(const fhicl::ParameterSet& p,
  ...
  std::vector<std::vector<double> > UBGenieWeightCalc::GetWeight(art::Event & e)
  {
  ...
  std::map< std::string, int > UBGenieWeightCalc::CheckForIncompatibleSystematics(
    const std::vector<genie::rew::GSyst_t>& knob_vec)
  {
  ...
  void UBGenieWeightCalc::SetupWeightCalculators(genie::rew::GReWeight& rw,
    const std::map<std::string, int>& modes_to_use)
  {
  ...
  REGISTER_WEIGHTCALC(UBGenieWeightCalc)
}
