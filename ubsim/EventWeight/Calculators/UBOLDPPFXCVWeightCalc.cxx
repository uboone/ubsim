...
class UBOLDPPFXCVWeightCalc : public WeightCalc
  {
  public:
    UBOLDPPFXCVWeightCalc();
  ...
  private:
    ...
    DECLARE_WEIGHTCALC(UBOLDPPFXCVWeightCalc)
  };

UBOLDPPFXCVWeightCalc::UBOLDPPFXCVWeightCalc()
{
}

double UBOLDPPFXCVWeightCalc::GetOldFluxReweight(const simb::MCFlux* mcflux)
{
...
void UBOLDPPFXCVWeightCalc::Configure(fhicl::ParameterSet const& p,
...
std::vector<std::vector<double> > UBOLDPPFXCVWeightCalc::GetWeight(art::Event & e)
{
...
REGISTER_WEIGHTCALC(UBOLDPPFXCVWeightCalc)
}
