...
namespace evwgh {
  class UBPPFXWeightCalc : public WeightCalc
  {
     public:
       UBPPFXWeightCalc();
     ...
     DECLARE_WEIGHTCALC(UBPPFXWeightCalc)
  };
  
  UBPPFXWeightCalc::UBPPFXWeightCalc()
  {
  }

  void UBPPFXWeightCalc::Configure(fhicl::ParameterSet const& p, 
  ...
  std::vector<std::vector<double> > UBPPFXWeightCalc::GetWeight(art::Event & e)
  {
  ...
  REGISTER_WEIGHTCALC(UBPPFXWeightCalc)
}
