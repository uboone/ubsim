...
namespace evwgh {
  class UBPPFXCVWeightCalc : public WeightCalc
  {
     public:
       UBPPFXCVWeightCalc();
     ...
     DECLARE_WEIGHTCALC(UBPPFXCVWeightCalc)
  };
  
  UBPPFXCVWeightCalc::UBPPFXCVWeightCalc()
  {
  }

  void UBPPFXCVWeightCalc::Configure(fhicl::ParameterSet const& p,
  ...
  std::vector<std::vector<double> > UBPPFXCVWeightCalc::GetWeight(art::Event & e)
  {
  ...
  REGISTER_WEIGHTCALC(UBPPFXCVWeightCalc)
}
