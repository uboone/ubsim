...
void FillTreeVariables::SetUpTreeBranches() {
  ...
  if(fmcordata == "mc") {
    ...
    fvertex_tree->Branch("longest_asso_track_matching_ratio", &longest_asso_track_matching_ratio, "longest_asso_track_matching_ratio/D");
...
void FillTreeVariables::FillTrackRecoMCMatching(art::Event const & e,
  ...
  if(longest_asso_track_match.mc_type == 1) {
    ...
    geoalgo::Point_t const longest_asso_track_dir(mcs.Start().Momentum());
    longest_asso_track_true_thetayx = atan(longest_asso_track_dir.at(1)/longest_asso_track_dir.at(0));
    longest_asso_track_true_thetaxz = atan(longest_asso_track_dir.at(0)/longest_asso_track_dir.at(2));
    ...
    longest_asso_track_true_startx = mcp.Position(mcp.NumberTrajectoryPoints()).X();
    longest_asso_track_true_starty = mcp.Position(mcp.NumberTrajectoryPoints()).Y();
    longest_asso_track_true_startz = mcp.Position(mcp.NumberTrajectoryPoints()).Z(); 
    geoalgo::Point_t const particle_dir(mcp.Momentum(0));
