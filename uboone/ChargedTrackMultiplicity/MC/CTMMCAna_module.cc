...
*/    fDataTreeCCSel->Branch("_fNtrueInAccpmult",&_fNtrueInAccpmult,"_fNtrueInAccpmult/I");
    ...
    fDataTreePassLongcolhits->Branch("_fTrueccnc",&_fTrueccnc,"_fTrueccnc/I");
    fDataTreePassLongcolhits->Branch("_fTruemode",&_fTruemode,"_fTruemode/I");
    fDataTreePassLongcolhits->Branch("_fTrueinttype",&_fTrueinttype,"_fTrueinttype/I");
    fDataTreePassLongcolhits->Branch("_fTruenupdg",&_fTruenupdg,"_fTruenupdg/I");
    fDataTreePassLongcolhits->Branch("_fTrueenu",&_fTrueenu,"_fTrueenu/F");
    fDataTreePassLongcolhits->Branch("_fTrueq2truth",&_fTrueq2truth,"_fTrueq2truth/F");
    fDataTreePassLongcolhits->Branch("_fTruenuvrtxx",&_fTruenuvrtxx,"_fTruenuvrtxx/F");
    fDataTreePassLongcolhits->Branch("_fTruenuvrtxy",&_fTruenuvrtxy,"_fTruenuvrtxy/F");
    fDataTreePassLongcolhits->Branch("_fTruenuvrtxz",&_fTruenuvrtxz,"_fTruenuvrtxz/F");
    fDataTreePassLongcolhits->Branch("_fTrueSPcorrnuvtxx",&_fTrueSPcorrnuvtxx,"_fTrueSPcorrnuvtxx/F");
    fDataTreePassLongcolhits->Branch("_fTrueSPcorrnuvtxy",&_fTrueSPcorrnuvtxy,"_fTrueSPcorrnuvtxy/F");
    fDataTreePassLongcolhits->Branch("_fTrueSPcorrnuvtxz",&_fTrueSPcorrnuvtxz,"_fTrueSPcorrnuvtxz/F");
    fDataTreePassLongcolhits->Branch("_fmctrue_origin",&_fmctrue_origin,"_fmctrue_origin/I");
    fDataTreePassLongcolhits->Branch("_ftrueVrtxOutFV",&_ftrueVrtxOutFV,"_ftrueVrtxOutFV/I");
    ...
    fDataTreePassLongcolhits->Branch("_fNGTrueallmult",&_fNGTrueallmult,"_fNGTrueallmult/I");   
    fDataTreePassLongcolhits->Branch("_fGtrueparID",&_fGtrueparID,"_fGtrueparID[_fNGTrueallmult]/I");
    fDataTreePassLongcolhits->Branch("_fGtrueparpdg",&_fGtrueparpdg,"_fGtrueparpdg[_fNGTrueallmult]/I");
    fDataTreePassLongcolhits->Branch("_fGtrueparStatusCode",&_fGtrueparStatusCode,"_fGtrueparStatusCode[_fNGTrueallmult]/I");
    fDataTreePassLongcolhits->Branch("_fGtrueparTheta",&_fGtrueparTheta,"_fGtrueparTheta[_fNGTrueallmult]/F");
    fDataTreePassLongcolhits->Branch("_fGtrueparCosTheta",&_fGtrueparCosTheta,"_fGtrueparCosTheta[_fNGTrueallmult]/F");	
    fDataTreePassLongcolhits->Branch("_fGtrueparSinTheta",&_fGtrueparSinTheta,"_fGtrueparSinTheta[_fNGTrueallmult]/F");
    fDataTreePassLongcolhits->Branch("_fGtrueparPhi",&_fGtrueparPhi,"_fGtrueparPhi[_fNGTrueallmult]/F");
    fDataTreePassLongcolhits->Branch("_fGtrueparCosPhi",&_fGtrueparCosPhi,"_fGtrueparCosPhi[_fNGTrueallmult]/F");    
    fDataTreePassLongcolhits->Branch("_fGtrueparSinPhi",&_fGtrueparSinPhi,"_fGtrueparSinPhi[_fNGTrueallmult]/F");    
    fDataTreePassLongcolhits->Branch("_fGtrueparE",&_fGtrueparE,"_fGtrueparE[_fNGTrueallmult]/F");
    fDataTreePassLongcolhits->Branch("_fGtrueparMass",&_fGtrueparMass,"_fGtrueparMass[_fNGTrueallmult]/F");
    fDataTreePassLongcolhits->Branch("_fGtrueparKE",&_fGtrueparKE,"_fGtrueparKE[_fNGTrueallmult]/F");
    fDataTreePassLongcolhits->Branch("_fGtrueparEndE",&_fGtrueparEndE,"_fGtrueparEndE[_fNGTrueallmult]/F");
    fDataTreePassLongcolhits->Branch("_fGtrueparPx",&_fGtrueparPx,"_fGtrueparPx[_fNGTrueallmult]/F");
    fDataTreePassLongcolhits->Branch("_fGtrueparPy",&_fGtrueparPy,"_fGtrueparPy[_fNGTrueallmult]/F");
    fDataTreePassLongcolhits->Branch("_fGtrueparPz",&_fGtrueparPz,"_fGtrueparPz[_fNGTrueallmult]/F");
    fDataTreePassLongcolhits->Branch("_fGtrueparP",&_fGtrueparP,"_fGtrueparP[_fNGTrueallmult]/F");
    fDataTreePassLongcolhits->Branch("_fGtrueparStartx",&_fGtrueparStartx,"_fGtrueparStartx[_fNGTrueallmult]/F");
    fDataTreePassLongcolhits->Branch("_fGtrueparStarty",&_fGtrueparStarty,"_fGtrueparStarty[_fNGTrueallmult]/F");
    fDataTreePassLongcolhits->Branch("_fGtrueparStartz",&_fGtrueparStartz,"_fGtrueparStartz[_fNGTrueallmult]/F");
    fDataTreePassLongcolhits->Branch("_fGtrueparEndx",&_fGtrueparEndx,"_fGtrueparEndx[_fNGTrueallmult]/F");
    fDataTreePassLongcolhits->Branch("_fGtrueparEndy",&_fGtrueparEndy,"_fGtrueparEndy[_fNGTrueallmult]/F");
    fDataTreePassLongcolhits->Branch("_fGtrueparEndz",&_fGtrueparEndz,"_fGtrueparEndz[_fNGTrueallmult]/F");
    fDataTreePassLongcolhits->Branch("_fGtrueparSPcorrStartx",&_fGtrueparSPcorrStartx,"_fGtrueparSPcorrStartx[_fNGTrueallmult]/F");
    fDataTreePassLongcolhits->Branch("_fGtrueparSPcorrStarty",&_fGtrueparSPcorrStarty,"_fGtrueparSPcorrStarty[_fNGTrueallmult]/F");
    fDataTreePassLongcolhits->Branch("_fGtrueparSPcorrStartz",&_fGtrueparSPcorrStartz,"_fGtrueparSPcorrStartz[_fNGTrueallmult]/F");
    fDataTreePassLongcolhits->Branch("_fGtrueparSPcorrEndx",&_fGtrueparSPcorrEndx,"_fGtrueparSPcorrEndx[_fNGTrueallmult]/F");
    fDataTreePassLongcolhits->Branch("_fGtrueparSPcorrEndy",&_fGtrueparSPcorrEndy,"_fGtrueparSPcorrEndy[_fNGTrueallmult]/F");
    fDataTreePassLongcolhits->Branch("_fGtrueparSPcorrEndz",&_fGtrueparSPcorrEndz,"_fGtrueparSPcorrEndz[_fNGTrueallmult]/F");
...
*/    fDataTreePassLongcolhits->Branch("_fNrecomult",&_fNrecomult,"_fNrecomult/I");
    ...
    fDataTreePassLongcolhits->Branch("_fNTruematchPart",&_fNTruematchPart,"_fNTruematchPart/I");   
    fDataTreePassLongcolhits->Branch("_ftruematchparID",&_ftruematchparID,"_ftruematchparID[_fNTruematchPart]/I");
    fDataTreePassLongcolhits->Branch("_ftruematchparpdg",&_ftruematchparpdg,"_ftruematchparpdg[_fNTruematchPart]/I");
    fDataTreePassLongcolhits->Branch("_ftruematchparStatusCode",&_ftruematchparStatusCode,"_ftruematchparStatusCode[_fNTruematchPart]/I");
    fDataTreePassLongcolhits->Branch("_ftruematchparTheta",&_ftruematchparTheta,"_ftruematchparTheta[_fNTruematchPart]/F");
    fDataTreePassLongcolhits->Branch("_ftruematchparCosTheta",&_ftruematchparCosTheta,"_ftruematchparCosTheta[_fNTruematchPart]/F");	
    fDataTreePassLongcolhits->Branch("_ftruematchparSinTheta",&_ftruematchparSinTheta,"_ftruematchparSinTheta[_fNTruematchPart]/F");
    fDataTreePassLongcolhits->Branch("_ftruematchparPhi",&_ftruematchparPhi,"_ftruematchparPhi[_fNTruematchPart]/F");
    fDataTreePassLongcolhits->Branch("_ftruematchparCosPhi",&_ftruematchparCosPhi,"_ftruematchparCosPhi[_fNTruematchPart]/F");    
    fDataTreePassLongcolhits->Branch("_ftruematchparSinPhi",&_ftruematchparSinPhi,"_ftruematchparSinPhi[_fNTruematchPart]/F");	 
    fDataTreePassLongcolhits->Branch("_ftruematchparE",&_ftruematchparE,"_ftruematchparE[_fNTruematchPart]/F");
    fDataTreePassLongcolhits->Branch("_ftruematchparMass",&_ftruematchparMass,"_ftruematchparMass[_fNTruematchPart]/F");
    fDataTreePassLongcolhits->Branch("_ftruematchparKE",&_ftruematchparKE,"_ftruematchparKE[_fNTruematchPart]/F");
    fDataTreePassLongcolhits->Branch("_ftruematchparEndE",&_ftruematchparEndE,"_ftruematchparEndE[_fNTruematchPart]/F");
    fDataTreePassLongcolhits->Branch("_ftruematchparPx",&_ftruematchparPx,"_ftruematchparPx[_fNTruematchPart]/F");
    fDataTreePassLongcolhits->Branch("_ftruematchparPy",&_ftruematchparPy,"_ftruematchparPy[_fNTruematchPart]/F");
    fDataTreePassLongcolhits->Branch("_ftruematchparPz",&_ftruematchparPz,"_ftruematchparPz[_fNTruematchPart]/F");
    fDataTreePassLongcolhits->Branch("_ftruematchparP",&_ftruematchparP,"_fTruematchparP[_fNTruematchPart]/F");
    fDataTreePassLongcolhits->Branch("_ftruematchparStartx",&_ftruematchparStartx,"_ftruematchparStartx[_fNTruematchPart]/F");
    fDataTreePassLongcolhits->Branch("_ftruematchparStarty",&_ftruematchparStarty,"_ftruematchparStarty[_fNTruematchPart]/F");
    fDataTreePassLongcolhits->Branch("_ftruematchparStartz",&_ftruematchparStartz,"_ftruematchparStartz[_fNTruematchPart]/F");
    fDataTreePassLongcolhits->Branch("_ftruematchparEndx",&_ftruematchparEndx,"_ftruematchparEndx[_fNTruematchPart]/F");
    fDataTreePassLongcolhits->Branch("_ftruematchparEndy",&_ftruematchparEndy,"_ftruematchparEndy[_fNTruematchPart]/F");
    fDataTreePassLongcolhits->Branch("_ftruematchparEndz",&_ftruematchparEndz,"_ftruematchparEndz[_fNTruematchPart]/F");
    fDataTreePassLongcolhits->Branch("_ftruematchparSPcorrStartx",&_ftruematchparSPcorrStartx,"_ftruematchparSPcorrStartx[_fNTruematchPart]/F");
    fDataTreePassLongcolhits->Branch("_ftruematchparSPcorrStarty",&_ftruematchparSPcorrStarty,"_ftruematchparSPcorrStarty[_fNTruematchPart]/F");
    fDataTreePassLongcolhits->Branch("_ftruematchparSPcorrStartz",&_ftruematchparSPcorrStartz,"_ftruematchparSPcorrStartz[_fNTruematchPart]/F");
    fDataTreePassLongcolhits->Branch("_ftruematchparSPcorrEndx",&_ftruematchparSPcorrEndx,"_ftruematchparSPcorrEndx[_fNTruematchPart]/F");
    fDataTreePassLongcolhits->Branch("_ftruematchparSPcorrEndy",&_ftruematchparSPcorrEndy,"_ftruematchparSPcorrEndy[_fNTruematchPart]/F");
    fDataTreePassLongcolhits->Branch("_ftruematchparSPcorrEndz",&_ftruematchparSPcorrEndz,"_ftruematchparSPcorrEndz[_fNTruematchPart]/F");
    fDataTreePassLongcolhits->Branch("_fNSecondaryselmult",&_fNSecondaryselmult,"_fNSecondaryselmult/I");
    fDataTreePassLongcolhits->Branch("_fSeconpargeantID",&_fSeconpargeantID,"_fSeconpargeantID[_fNSecondaryselmult]/I");
    fDataTreePassLongcolhits->Branch("_fSeconparpdg",&_fSeconparpdg,"_fSeconparpdg[_fNSecondaryselmult]/I");
    fDataTreePassLongcolhits->Branch("_fSeconparStatusCode",&_fSeconparStatusCode,"_fSeconparStatusCode[_fNSecondaryselmult]/I");
    fDataTreePassLongcolhits->Branch("_fSeconparTheta",&_fSeconparTheta,"_fSeconparTheta[_fNSecondaryselmult]/F");
    fDataTreePassLongcolhits->Branch("_fSeconparCosTheta",&_fSeconparCosTheta,"_fSeconparCosTheta[_fNSecondaryselmult]/F");    
    fDataTreePassLongcolhits->Branch("_fSeconparSinTheta",&_fSeconparSinTheta,"_fSeconparSinTheta[_fNSecondaryselmult]/F");
    fDataTreePassLongcolhits->Branch("_fSeconparPhi",&_fSeconparPhi,"_fSeconparPhi[_fNSecondaryselmult]/F");
    fDataTreePassLongcolhits->Branch("_fSeconparCosPhi",&_fSeconparCosPhi,"_fSeconparCosPhi[_fNSecondaryselmult]/F");	 
    fDataTreePassLongcolhits->Branch("_fSeconparSinPhi",&_fSeconparSinPhi,"_fSeconparSinPhi[_fNSecondaryselmult]/F");    
    fDataTreePassLongcolhits->Branch("_fSeconparE",&_fSeconparE,"_fSeconparE[_fNSecondaryselmult]/F");
    fDataTreePassLongcolhits->Branch("_fSeconparMass",&_fSeconparMass,"_fSeconparMass[_fNSecondaryselmult]/F");
    fDataTreePassLongcolhits->Branch("_fSeconparKE",&_fSeconparKE,"_fSeconparKE[_fNSecondaryselmult]/F");
    fDataTreePassLongcolhits->Branch("_fSeconparEndE",&_fSeconparEndE,"_fSeconparEndE[_fNSecondaryselmult]/F");
    fDataTreePassLongcolhits->Branch("_fSeconparPx",&_fSeconparPx,"_fSeconparPx[_fNSecondaryselmult]/F");
    fDataTreePassLongcolhits->Branch("_fSeconparPy",&_fSeconparPy,"_fSeconparPy[_fNSecondaryselmult]/F");
    fDataTreePassLongcolhits->Branch("_fSeconparPz",&_fSeconparPz,"_fSeconparPz[_fNSecondaryselmult]/F");
    fDataTreePassLongcolhits->Branch("_fSeconparP",&_fSeconparP,"_fSeconparP[_fNSecondaryselmult]/F");
    fDataTreePassLongcolhits->Branch("_fSeconparStartx",&_fSeconparStartx,"_fSeconparStartx[_fNSecondaryselmult]/F");
    fDataTreePassLongcolhits->Branch("_fSeconparStarty",&_fSeconparStarty,"_fSeconparStarty[_fNSecondaryselmult]/F");
    fDataTreePassLongcolhits->Branch("_fSeconparStartz",&_fSeconparStartz,"_fSeconparStartz[_fNSecondaryselmult]/F");
    fDataTreePassLongcolhits->Branch("_fSeconparEndx",&_fSeconparEndx,"_fSeconparEndx[_fNSecondaryselmult]/F");
    fDataTreePassLongcolhits->Branch("_fSeconparEndy",&_fSeconparEndy,"_fSeconparEndy[_fNSecondaryselmult]/F");
    fDataTreePassLongcolhits->Branch("_fSeconparEndz",&_fSeconparEndz,"_fSeconparEndz[_fNSecondaryselmult]/F");
    fDataTreePassLongcolhits->Branch("_fSeconparSPcorrStartx",&_fSeconparSPcorrStartx,"_fSeconparSPcorrStartx[_fNSecondaryselmult]/F");
    fDataTreePassLongcolhits->Branch("_fSeconparSPcorrStarty",&_fSeconparSPcorrStarty,"_fSeconparSPcorrStarty[_fNSecondaryselmult]/F");
    fDataTreePassLongcolhits->Branch("_fSeconparSPcorrStartz",&_fSeconparSPcorrStartz,"_fSeconparSPcorrStartz[_fNSecondaryselmult]/F");
    fDataTreePassLongcolhits->Branch("_fSeconparSPcorrEndx",&_fSeconparSPcorrEndx,"_fSeconparSPcorrEndx[_fNSecondaryselmult]/F");
    fDataTreePassLongcolhits->Branch("_fSeconparSPcorrEndy",&_fSeconparSPcorrEndy,"_fSeconparSPcorrEndy[_fNSecondaryselmult]/F");
    fDataTreePassLongcolhits->Branch("_fSeconparSPcorrEndz",&_fSeconparSPcorrEndz,"_fSeconparSPcorrEndz[_fNSecondaryselmult]/F");
    fDataTreePassLongcolhits->Branch("_fNTrueallPart",&_fNTrueallPart,"_fNTrueallPart/I");   
/*  fDataTreePassLongcolhits->Branch("_ftrueparID",&_ftrueparID,"_ftrueparID[_fNTrueallPart]/I");
    fDataTreePassLongcolhits->Branch("_ftrueparpdg",&_ftrueparpdg,"_ftrueparpdg[_fNTrueallPart]/I");
    fDataTreePassLongcolhits->Branch("_ftrueparStatusCode",&_ftrueparStatusCode,"_ftrueparStatusCode[_fNTrueallPart]/I");
    fDataTreePassLongcolhits->Branch("_ftrueparTheta",&_ftrueparTheta,"_ftrueparTheta[_fNTrueallPart]/F");
    fDataTreePassLongcolhits->Branch("_ftrueparCosTheta",&_ftrueparCosTheta,"_ftrueparCosTheta[_fNTrueallPart]/F");	
    fDataTreePassLongcolhits->Branch("_ftrueparSinTheta",&_ftrueparSinTheta,"_ftrueparSinTheta[_fNTrueallPart]/F");
    fDataTreePassLongcolhits->Branch("_ftrueparPhi",&_ftrueparPhi,"_ftrueparPhi[_fNTrueallPart]/F");
    fDataTreePassLongcolhits->Branch("_ftrueparCosPhi",&_ftrueparCosPhi,"_ftrueparCosPhi[_fNTrueallPart]/F");    
    fDataTreePassLongcolhits->Branch("_ftrueparSinPhi",&_ftrueparSinPhi,"_ftrueparSinPhi[_fNTrueallPart]/F");    
    fDataTreePassLongcolhits->Branch("_ftrueparE",&_ftrueparE,"_ftrueparE[_fNTrueallPart]/F");
    fDataTreePassLongcolhits->Branch("_ftrueparMass",&_ftrueparMass,"_ftrueparMass[_fNTrueallPart]/F");
    fDataTreePassLongcolhits->Branch("_ftrueparKE",&_ftrueparKE,"_ftrueparKE[_fNTrueallPart]/F");
    fDataTreePassLongcolhits->Branch("_ftrueparEndE",&_ftrueparEndE,"_ftrueparEndE[_fNTrueallPart]/F");
    fDataTreePassLongcolhits->Branch("_ftrueparPx",&_ftrueparPx,"_ftrueparPx[_fNTrueallPart]/F");
    fDataTreePassLongcolhits->Branch("_ftrueparPy",&_ftrueparPy,"_ftrueparPy[_fNTrueallPart]/F");
    fDataTreePassLongcolhits->Branch("_ftrueparPz",&_ftrueparPz,"_ftrueparPz[_fNTrueallPart]/F");
    fDataTreePassLongcolhits->Branch("_ftrueparP",&_ftrueparP,"_fTrueparP[_fNTrueallPart]/F");
    fDataTreePassLongcolhits->Branch("_ftrueparStartx",&_ftrueparStartx,"_ftrueparStartx[_fNTrueallPart]/F");
    fDataTreePassLongcolhits->Branch("_ftrueparStarty",&_ftrueparStarty,"_ftrueparStarty[_fNTrueallPart]/F");
    fDataTreePassLongcolhits->Branch("_ftrueparStartz",&_ftrueparStartz,"_ftrueparStartz[_fNTrueallPart]/F");
    fDataTreePassLongcolhits->Branch("_ftrueparEndx",&_ftrueparEndx,"_ftrueparEndx[_fNTrueallPart]/F");
    fDataTreePassLongcolhits->Branch("_ftrueparEndy",&_ftrueparEndy,"_ftrueparEndy[_fNTrueallPart]/F");
    fDataTreePassLongcolhits->Branch("_ftrueparEndz",&_ftrueparEndz,"_ftrueparEndz[_fNTrueallPart]/F");
*/    fDataTreePassLongcolhits->Branch("_fNtrueInAccpmult",&_fNtrueInAccpmult,"_fNtrueInAccpmult/I");
    fDataTreePassLongcolhits->Branch("_ftrueInAccppargeantID",&_ftrueInAccppargeantID,"_ftrueInAccppargeantID[_fNtrueInAccpmult]/I");
    fDataTreePassLongcolhits->Branch("_ftrueInAccpparpdg",&_ftrueInAccpparpdg,"_ftrueInAccpparpdg[_fNtrueInAccpmult]/I");
    fDataTreePassLongcolhits->Branch("_ftrueInAccpparStatusCode",&_ftrueInAccpparStatusCode,"_ftrueInAccpparStatusCode[_fNtrueInAccpmult]/I");
    fDataTreePassLongcolhits->Branch("_ftrueInAccpparTheta",&_ftrueInAccpparTheta,"_ftrueInAccpparTheta[_fNtrueInAccpmult]/F");
    fDataTreePassLongcolhits->Branch("_ftrueInAccpparCosTheta",&_ftrueInAccpparCosTheta,"_ftrueInAccpparCosTheta[_fNtrueInAccpmult]/F");	
    fDataTreePassLongcolhits->Branch("_ftrueInAccpparSinTheta",&_ftrueInAccpparSinTheta,"_ftrueInAccpparSinTheta[_fNtrueInAccpmult]/F");
    fDataTreePassLongcolhits->Branch("_ftrueInAccpparPhi",&_ftrueInAccpparPhi,"_ftrueInAccpparPhi[_fNtrueInAccpmult]/F");
    fDataTreePassLongcolhits->Branch("_ftrueInAccpparCosPhi",&_ftrueInAccpparCosPhi,"_ftrueInAccpparCosPhi[_fNtrueInAccpmult]/F");    
    fDataTreePassLongcolhits->Branch("_ftrueInAccpparSinPhi",&_ftrueInAccpparSinPhi,"_ftrueInAccpparSinPhi[_fNtrueInAccpmult]/F");    
    fDataTreePassLongcolhits->Branch("_ftrueInAccpparE",&_ftrueInAccpparE,"_ftrueInAccpparE[_fNtrueInAccpmult]/F");
    fDataTreePassLongcolhits->Branch("_ftrueInAccpparMass",&_ftrueInAccpparMass,"_ftrueInAccpparMass[_fNtrueInAccpmult]/F");
    fDataTreePassLongcolhits->Branch("_ftrueInAccpparKE",&_ftrueInAccpparKE,"_ftrueInAccpparKE[_fNtrueInAccpmult]/F");
    fDataTreePassLongcolhits->Branch("_ftrueInAccpparEndE",&_ftrueInAccpparEndE,"_ftrueInAccpparEndE[_fNtrueInAccpmult]/F");
    fDataTreePassLongcolhits->Branch("_ftrueInAccpparPx",&_ftrueInAccpparPx,"_ftrueInAccpparPx[_fNtrueInAccpmult]/F");
    fDataTreePassLongcolhits->Branch("_ftrueInAccpparPy",&_ftrueInAccpparPy,"_ftrueInAccpparPy[_fNtrueInAccpmult]/F");
    fDataTreePassLongcolhits->Branch("_ftrueInAccpparPz",&_ftrueInAccpparPz,"_ftrueInAccpparPz[_fNtrueInAccpmult]/F");
    fDataTreePassLongcolhits->Branch("_ftrueInAccpparP",&_ftrueInAccpparP,"_fTrueInAccpparP[_fNtrueInAccpmult]/F");
    fDataTreePassLongcolhits->Branch("_ftrueInAccpparStartx",&_ftrueInAccpparStartx,"_ftrueInAccpparStartx[_fNtrueInAccpmult]/F");
    fDataTreePassLongcolhits->Branch("_ftrueInAccpparStarty",&_ftrueInAccpparStarty,"_ftrueInAccpparStarty[_fNtrueInAccpmult]/F");
    fDataTreePassLongcolhits->Branch("_ftrueInAccpparStartz",&_ftrueInAccpparStartz,"_ftrueInAccpparStartz[_fNtrueInAccpmult]/F");
    fDataTreePassLongcolhits->Branch("_ftrueInAccpparEndx",&_ftrueInAccpparEndx,"_ftrueInAccpparEndx[_fNtrueInAccpmult]/F");
    fDataTreePassLongcolhits->Branch("_ftrueInAccpparEndy",&_ftrueInAccpparEndy,"_ftrueInAccpparEndy[_fNtrueInAccpmult]/F");
    fDataTreePassLongcolhits->Branch("_ftrueInAccpparEndz",&_ftrueInAccpparEndz,"_ftrueInAccpparEndz[_fNtrueInAccpmult]/F");
    fDataTreePassLongcolhits->Branch("_ftrueInAccpparSPcorrStartx",&_ftrueInAccpparSPcorrStartx,"_ftrueInAccpparSPcorrStartx[_fNtrueInAccpmult]/F");
    fDataTreePassLongcolhits->Branch("_ftrueInAccpparSPcorrStarty",&_ftrueInAccpparSPcorrStarty,"_ftrueInAccpparSPcorrStarty[_fNtrueInAccpmult]/F");
    fDataTreePassLongcolhits->Branch("_ftrueInAccpparSPcorrStartz",&_ftrueInAccpparSPcorrStartz,"_ftrueInAccpparSPcorrStartz[_fNtrueInAccpmult]/F");
    fDataTreePassLongcolhits->Branch("_ftrueInAccpparSPcorrEndx",&_ftrueInAccpparSPcorrEndx,"_ftrueInAccpparSPcorrEndx[_fNtrueInAccpmult]/F");
    fDataTreePassLongcolhits->Branch("_ftrueInAccpparSPcorrEndy",&_ftrueInAccpparSPcorrEndy,"_ftrueInAccpparSPcorrEndy[_fNtrueInAccpmult]/F");
    fDataTreePassLongcolhits->Branch("_ftrueInAccpparSPcorrEndz",&_ftrueInAccpparSPcorrEndz,"_ftrueInAccpparSPcorrEndz[_fNtrueInAccpmult]/F");
    ...
    fDataTreePassLongcolhits->Branch("_ftruelongInAccppargeantID",&_ftruelongInAccppargeantID,"_ftruelongInAccppargeantID[_fNtruelongInAccpmult]/I");
    fDataTreePassLongcolhits->Branch("_ftruelongInAccpparpdg",&_ftruelongInAccpparpdg,"_ftruelongInAccpparpdg[_fNtruelongInAccpmult]/I");
    fDataTreePassLongcolhits->Branch("_ftruelongInAccpparStatusCode",&_ftruelongInAccpparStatusCode,"_ftruelongInAccpparStatusCode[_fNtruelongInAccpmult]/I");
    fDataTreePassLongcolhits->Branch("_ftruelongInAccpparTheta",&_ftruelongInAccpparTheta,"_ftruelongInAccpparTheta[_fNtruelongInAccpmult]/F");
    fDataTreePassLongcolhits->Branch("_ftruelongInAccpparCosTheta",&_ftruelongInAccpparCosTheta,"_ftruelongInAccpparCosTheta[_fNtruelongInAccpmult]/F");    
    fDataTreePassLongcolhits->Branch("_ftruelongInAccpparSinTheta",&_ftruelongInAccpparSinTheta,"_ftruelongInAccpparSinTheta[_fNtruelongInAccpmult]/F");
    fDataTreePassLongcolhits->Branch("_ftruelongInAccpparPhi",&_ftruelongInAccpparPhi,"_ftruelongInAccpparPhi[_fNtruelongInAccpmult]/F");
    fDataTreePassLongcolhits->Branch("_ftruelongInAccpparCosPhi",&_ftruelongInAccpparCosPhi,"_ftruelongInAccpparCosPhi[_fNtruelongInAccpmult]/F");       
    fDataTreePassLongcolhits->Branch("_ftruelongInAccpparSinPhi",&_ftruelongInAccpparSinPhi,"_ftruelongInAccpparSinPhi[_fNtruelongInAccpmult]/F");    
    fDataTreePassLongcolhits->Branch("_ftruelongInAccpparE",&_ftruelongInAccpparE,"_ftruelongInAccpparE[_fNtruelongInAccpmult]/F");
    fDataTreePassLongcolhits->Branch("_ftruelongInAccpparMass",&_ftruelongInAccpparMass,"_ftruelongInAccpparMass[_fNtruelongInAccpmult]/F");
    fDataTreePassLongcolhits->Branch("_ftruelongInAccpparKE",&_ftruelongInAccpparKE,"_ftruelongInAccpparKE[_fNtruelongInAccpmult]/F");
    fDataTreePassLongcolhits->Branch("_ftruelongInAccpparEndE",&_ftruelongInAccpparEndE,"_ftruelongInAccpparEndE[_fNtruelongInAccpmult]/F");
    fDataTreePassLongcolhits->Branch("_ftruelongInAccpparPx",&_ftruelongInAccpparPx,"_ftruelongInAccpparPx[_fNtruelongInAccpmult]/F");
    fDataTreePassLongcolhits->Branch("_ftruelongInAccpparPy",&_ftruelongInAccpparPy,"_ftruelongInAccpparPy[_fNtruelongInAccpmult]/F");
    fDataTreePassLongcolhits->Branch("_ftruelongInAccpparPz",&_ftruelongInAccpparPz,"_ftruelongInAccpparPz[_fNtruelongInAccpmult]/F");
    fDataTreePassLongcolhits->Branch("_ftruelongInAccpparP",&_ftruelongInAccpparP,"_ftruelongInAccpparP[_fNtruelongInAccpmult]/F");
    fDataTreePassLongcolhits->Branch("_ftruelongInAccpparStartx",&_ftruelongInAccpparStartx,"_ftruelongInAccpparStartx[_fNtruelongInAccpmult]/F");
    fDataTreePassLongcolhits->Branch("_ftruelongInAccpparStarty",&_ftruelongInAccpparStarty,"_ftruelongInAccpparStarty[_fNtruelongInAccpmult]/F");
    fDataTreePassLongcolhits->Branch("_ftruelongInAccpparStartz",&_ftruelongInAccpparStartz,"_ftruelongInAccpparStartz[_fNtruelongInAccpmult]/F");
    fDataTreePassLongcolhits->Branch("_ftruelongInAccpparEndx",&_ftruelongInAccpparEndx,"_ftruelongInAccpparEndx[_fNtruelongInAccpmult]/F");
    fDataTreePassLongcolhits->Branch("_ftruelongInAccpparEndy",&_ftruelongInAccpparEndy,"_ftruelongInAccpparEndy[_fNtruelongInAccpmult]/F");
    fDataTreePassLongcolhits->Branch("_ftruelongInAccpparEndz",&_ftruelongInAccpparEndz,"_ftruelongInAccpparEndz[_fNtruelongInAccpmult]/F");
    fDataTreePassLongcolhits->Branch("_ftruelongInAccpparSPcorrStartx",&_ftruelongInAccpparSPcorrStartx,"_ftruelongInAccpparSPcorrStartx[_fNtruelongInAccpmult]/F");
    fDataTreePassLongcolhits->Branch("_ftruelongInAccpparSPcorrStarty",&_ftruelongInAccpparSPcorrStarty,"_ftruelongInAccpparSPcorrStarty[_fNtruelongInAccpmult]/F");
    fDataTreePassLongcolhits->Branch("_ftruelongInAccpparSPcorrStartz",&_ftruelongInAccpparSPcorrStartz,"_ftruelongInAccpparSPcorrStartz[_fNtruelongInAccpmult]/F");
    fDataTreePassLongcolhits->Branch("_ftruelongInAccpparSPcorrEndx",&_ftruelongInAccpparSPcorrEndx,"_ftruelongInAccpparSPcorrEndx[_fNtruelongInAccpmult]/F");
    fDataTreePassLongcolhits->Branch("_ftruelongInAccpparSPcorrEndy",&_ftruelongInAccpparSPcorrEndy,"_ftruelongInAccpparSPcorrEndy[_fNtruelongInAccpmult]/F");
    fDataTreePassLongcolhits->Branch("_ftruelongInAccpparSPcorrEndz",&_ftruelongInAccpparSPcorrEndz,"_ftruelongInAccpparSPcorrEndz[_fNtruelongInAccpmult]/F");
